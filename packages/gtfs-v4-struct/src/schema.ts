...
export type GtfsV4ColumnRequirement =
  | "required"
  | "conditional_required"
  | "recommended"
  | "optional"
...
export type GtfsV4ColumnSchema = {
  required?: true;
  requirement?: GtfsV4ColumnRequirement;
  kind?: "string" | "number";
  values?: readonly (string | number)[];
};

export type GtfsV4TableSchema = {
  fileName: string;
  tableName: string;
  requirement: GtfsV4Requirement;
  format?: "txt" | "geojson";
  columns: Record<string, GtfsV4ColumnSchema>;
};
...
] as const satisfies readonly GtfsV4TableSchema[];
